    ...
    return (
        <div className='p-5'>
            <header className='text-center'>
                <h1 className="text-3xl font-bold m-5">Privacy Policy</h1>
            </header>
            <article>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named SOS YOUSSOUFIA</p>
                    </li>
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to SOS YOUSSOUFIA.</p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: najjarmedd@gmail.com</li>
                </ul>
            </article>
        </div>
    )
